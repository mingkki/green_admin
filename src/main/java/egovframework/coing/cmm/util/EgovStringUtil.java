...
public class EgovStringUtil {
    ...
    public static String getEmail(String email1, String email2) {
        
        email1 = nullConvert(email1, "");
        email2 = nullConvert(email2, "");
        if("".equals(email1)) {
            return "";
        }
    ...
    public static String getTel(String tel1, String tel2, String tel3) {
        ...
        tel1 = nullConvert(tel1, "");
        tel2 = nullConvert(tel2, "");
        tel3 = nullConvert(tel3, "");
        if("".equals(tel1)) {
            return "";
        }
    ...
    public static int emptyNullToZero(String str) {
