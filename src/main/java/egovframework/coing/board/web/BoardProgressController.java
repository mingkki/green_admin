...
public class BoardProgressController {
     ...
     * 게시판 정보 목록을 조회한다.
     */
    @RequestMapping(params = "act=progress", method = RequestMethod.GET)
    public String progressForm(@ModelAttribute("searchBoardInfoVO") BoardInfoVO searchBoardInfoVO,
        ...
        if(boardInfoVO == null) {
            ...
            return CmsManager.alert(CONTENT_PATH + "progress_result.jsp", model);
        }
        ...
        if("insert".equals(command)) {
            searchBoardCategoryVO.setBcaType("P");
            ...
            if(writeBoardCategoryVO == null) {
                model.addAttribute("message", "board.progress.nodata");
                return CmsManager.alert(CONTENT_PATH + "progress_result.jsp", model);
            }
        }
        ...
        model.addAttribute("CONTENT_FILE", CONTENT_PATH + "progress_form.jsp");
        return "egovframework/coing/common/admin_view";
    }
    
    
    @RequestMapping(params = "act=progress", method = RequestMethod.POST)
    public String progressSubmit(@ModelAttribute("searchBoardInfoVO") BoardInfoVO searchBoardInfoVO,
                                 @ModelAttribute("searchBoardCategoryVO") BoardCategoryVO searchBoardCategoryVO,
                                 @ModelAttribute("writeBoardCategory") BoardCategoryVO writeBoardCategoryVO,
                                 @RequestParam(value = "brdId", required = true) String brdId,
                                 @RequestParam(value = "bcaId", required = false, defaultValue = "0") int bcaId,
        ...
        if("insert".equals(command)) {
            ...
            writeBoardCategoryVO.setBcaType("P");
    ...
    @RequestMapping(params = "act=pdelete", method = RequestMethod.POST)
    public String pdelete(@ModelAttribute("searchBoardInfoVO") BoardInfoVO searchBoardInfoVO,
                          @ModelAttribute("searchBoardCategoryVO") BoardCategoryVO searchBoardCategoryVO,
                          @RequestParam(value = "brdId", required = true) String brdId,
