	...
	<div class="col-lg-12">
		<div class="block">
			<div class="block-head">
				<div class="pull-left">
					<h4><c:out value="${boardInfoVO.brdName}"/> 카테고리 관리</h4>
				</div>
			...
			<div class="block-content np">
				...
				<thead>
					<tr>
						...
						<th scope="col" class="text-center">카테고리명</th>
				...
				<c:forEach var="result" items="${boardCategoryList}" varStatus="status">
					<tr>
						...
						<td class="text-center">
							<a href="?act=category&amp;brdId=<c:out value='${result.brdId}'/>&amp;bcaId=<c:out value='${result.bcaId}'/>&amp;<c:out value='${searchBoardInfoVO.queryString}'/>" class="btn btn-default btn-xs">수정</a>
							<a href="javascript:post_delete('', 'act=cdelete&brdId=<c:out value="${result.brdId}"/>&bcaId=<c:out value="${result.bcaId}"/>&<c:out value="${searchBoardInfoVO.queryString}"/>');" class="btn btn-default btn-xs">삭제</a>
						</td>
					</tr>
				</c:forEach>
			...
			<div class="block-footer">
				<div class="clearfix">
					...
					<div class="pull-right">
						<a href="?act=category&amp;brdId=<c:out value='${searchBoardInfoVO.brdId}'/>&amp;mode=insert&amp;<c:out value='${searchBoardInfoVO.queryString}'/>" class="btn btn-primary">등록</a>
					</div>
				</div>
			</div>			
		</div>
		...
		<div class="block">		
			<form:form commandName="writeBoardCategory" action="?act=category" class="form-horizontal" role="form">
				...
				<fieldset>
					...
					<div class="block-content">
						<div class="form-group">
							<span class="col-sm-2 text-right"><label for="bcaTitle" class="control-label">* 카테고리명</label></span>
							<div class="col-sm-10">
