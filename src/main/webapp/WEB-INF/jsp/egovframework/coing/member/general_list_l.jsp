				...
				<div class="block-content np">
					...
					<thead>
						<tr>
							...
							<th scope="col" class="text-center">잠김일시</th>
							<th scope="col" class="text-center">잠김사유</th>
					...
					<c:forEach var="result" items="${resultList}" varStatus="status">
						<tr>
							...
							<td class="text-center"><c:out value="${result.memLockDttm}"/></td>							
							<td class="text-center"><c:out value="${result.memLockMemo}"/></td>
					...
					<c:if test="${fn:length(resultList) == 0}">
						<tr>
							<td colspan="9" class="text-center"><spring:message code="common.nodata" /></td>
						</tr>
					</c:if>
					</tbody>
					</table>
