	...
	<div class="col-lg-12">
		<div class="block">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="#">년도별</a></li>
			...
			<div class="block-content">
				<table class="table">
					...
					<tbody>
						...
						<fmt_rt:formatNumber var="percentHits" value="${sumHits == 0 ? 0 : (result.scdHits / sumHits * 100)}" maxFractionDigits="1" />
						<fmt_rt:formatNumber var="percentUniqHits" value="${sumUniqHits == 0 ? 0 : (result.scdUniqHits / sumUniqHits * 100)}" maxFractionDigits="1" />						
						<tr>
